        ...
        <div>
            ...
            <div className="ligueOne__container">
                <div className="ligueOne__title">  
                    <img className="img__title" src="https://media.api-sports.io/football/leagues/64.png" alt="Ligue 1 logo"/>
                    <h2 className="ligueOne__group">D1 Féminine</h2>
                </div>
