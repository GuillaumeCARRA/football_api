...
function Bundesliga({league, season}) {
    ...
    return (
        <div className="bundesliga" id="bundesliga">
           <div className="ligueOne">
        <div className="ligueOne__container">
            <div className="ligueOne__title">  
                <img className="img__title" src="https://media.api-sports.io/football/leagues/78.png" alt="Ligue 1 logo"/>
                <h2 className="ligueOne__group">BundesLiga</h2>
            </div>
